...
namespace archiver.ConsoleColorWriter
{
    /// <summary>
    ...
    public static class ConsoleWriter
    {
        ...
        public static void WriteColoredText(string pText, ConsoleColor pFrontColor, bool pWriteLine = true, bool pWriteCurrentTime = false)
        {
